...
$_['help_product_count']               = 'Показывать количество товаров.<b>Включение этой опции может привести к большим задеркам для магазинов с большим количеством товаров!</b>';
...
$_['help_login_attempts']              = 'Максимальное число попыток авторизации перед блокировкой на 1 час. Пользовательские и партнерские аккаунты возможно разблокировать в ручную в соответствующих разделах.';
...
$_['help_affiliate_approval']          = 'Автоматическое подтверждение вновь зарегистрировавшихся партнеров.';
...
$_['help_mail_alert']                  = 'Дополнительные E-Mail для получения оповещений на них. (разделитель — запятая).';
