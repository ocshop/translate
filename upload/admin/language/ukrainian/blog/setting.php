...
$_['help_article_count']               = 'Показывает количество статей в подкатегориях пользовательской части. Осторожно!!! Данная опция увеличивает нагрузку на сервер при большом количестве статей!';
